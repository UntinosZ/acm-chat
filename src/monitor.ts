...
async function processMessageWithPipeline(params: {
  ...
  const ctxPayload = core.channel.reply.finalizeInboundContext({
    ...
    OriginatingChannel: "acm-chat",
    OriginatingTo: `acm-chat:${spaceId}`,
  });
...
async function deliverGoogleChatReply(params: {
  ...
  if (payload.text) {
    ...
    const chunkMode = core.channel.text.resolveChunkMode(config, "acm-chat", account.accountId);
